...
const MODEL_CHOICES = [
  { id: 'claude-opus-4-7',   provider: 'anthropic', label: 'Claude Opus 4.7 — més precís (recomanat)' },
  ...
  { id: 'gemini-2.5-pro',         provider: 'google', label: 'Gemini 2.5 Pro — alternativa Google (potent)' },
  { id: 'gemini-2.5-flash',       provider: 'google', label: 'Gemini 2.5 Flash — alternativa Google (ràpid)' },
