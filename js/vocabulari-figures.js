...
window.VocabFigures = (() => {
    ...
    const FIGURES = [
        ...
        // 13. ORTOEDRE
        {
            ...
            `,
            etiquetes: [
                /* [ROUND 2 — imatge 2] ortoedre ara apunta al centre de la
                 * cara superior (238,148) en lloc de (210,235) que compartia
                 * amb "cara" → els dos connectors surten de punts distints */
                { id: 'ortoedre', text: 'ortoedre', px: 238, py: 148, lx: 210, ly: 20  },
